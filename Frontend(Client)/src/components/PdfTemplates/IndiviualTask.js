...
export default function IndiviualTask() {
  ...
  const get = async () => {
    const res = await axios.get(`http://localhost:4000/Task/ShowOneReport/${tid}`);
          ...
          <div>
            ...
            <div style={{ marginBottom: "40px" }}>
              <div>
                ...
                <p>
                  <b> Members Allocated: </b> {Rep.AssignMember.map((i)=>{return(<p>{i.Name}</p>)})}
                </p>
              </div>
              <div
                style={{
              ...
              >
                {Rep.Task.map((q,index)=>{return(<div>
                  <h2
                    style={{
                      textAlign: "left",
                      marginTop: 35,
                  ...
                  <div className="row">
                    ...
                    {q.taskType=="Create SOS"||q.taskType=="Update SOS"?
                    (<div className="col">
                    <p>
                      <b>Program: </b> {Rep.Program}
                    </p>
